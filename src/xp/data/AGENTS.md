...
Global instructions for the [xp](https://github.com/245678000000/xp) harness
(standalone `xp` CLI and/or Grok Build). Project-level `AGENTS.md` takes precedence when it conflicts.
